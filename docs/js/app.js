(() => {
    ...
    function menuInit() {
        if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".icon-menu")) {
                ...
                if (!e.target.closest(".menu__logo")) document.documentElement.classList.remove("menu-open");
            } else if (e.target.closest(".header") && e.target.closest(".menu__logo")) document.documentElement.classList.remove("menu-open");
        }));
    }
            ...
            document.addEventListener("click", function(e) {
                ...
                if (buttonOpen) {
                    ...
                    if (this._dataValue !== "error") {
                        ...
                        this.buttonId = buttonOpen.id || "no-id";
                        this.open();
                        return;
                    }
                    return;
                ...
                if (this.targetOpen.element) {
                    ...
                    fetch("files/data.json").then((response => response.json())).then((data => {
                        if (Array.isArray(data)) {
                            ...
                            if (popupData) {
                                this.targetOpen.element.querySelector(".popup__title").innerHTML = popupData.title || "";
                                this.targetOpen.element.querySelector(".popup__name").textContent = popupData.name || "";
                                this.targetOpen.element.querySelector(".popup__subtitle").textContent = popupData.subtitle || "";
                                this.targetOpen.element.querySelector(".popup__name-icon").innerHTML = popupData.icon || "";
                                this.targetOpen.element.querySelector(".popup__images-wr-v").innerHTML = popupData.imageVertical || "";
                                this.targetOpen.element.querySelector(".popup__images-wr-h").innerHTML = popupData.imageHorizontal || "";
                                this.targetOpen.element.querySelector(".info-popup__txt").innerHTML = popupData.text || "";
                                this.targetOpen.element.querySelector(".info-popup__link").setAttribute("href", popupData.link || "#");
                                this.targetOpen.element.querySelector(".info-popup__images").innerHTML = popupData.imageSecond || "";
                                this.targetOpen.element.querySelector(".block-comp-1").innerHTML = popupData["block-1"] || "";
                                this.targetOpen.element.querySelector(".block-comp-2").innerHTML = popupData["block-2"] || "";
                            }
                        }
    ...
    class FullPage {
        ...
        styleSlider() {
            for (let index = 0; index < this.sections.length; index++) {
                ...
                if (index === this.activeSectionId) {
                    ...
                    if (section.classList.contains("_hide-header") && section.classList.contains("active-section")) header.classList.add("header-hide");
                    if (!section.classList.contains("_hide-header") && section.classList.contains("active-section")) header.classList.remove("header-hide");
                } else if (index < this.activeSectionId) section.style.transform = "translate3D(0,-100%,0)"; else if (index > this.activeSectionId) section.style.transform = "translate3D(0,100%,0)";
            }
        }
        removeStyle() {
            for (let index = 0; index < this.sections.length; index++) {
        ...
        setEvents() {
            ...
            const heroLinkBtn = document.querySelector(".circle__link.link-big");
            if (menuLogo) menuLogo.addEventListener("click", (() => {
                this.switchingSection(0);
            }));
            if (secBlack) secBlack.addEventListener("click", (() => {
                this.switchingSection(1);
            }));
            if (secGreen) secGreen.addEventListener("click", (() => {
            ...
            if (menuHeroType) menuHeroType.addEventListener("click", (() => {
                this.switchingSection(1);
            }));
        ...
        fetch("files/data.json").then((response => response.json())).then((data => {
            if (Array.isArray(data)) data.forEach((item => {
                ...
                if (packItem) {
                    ...
                    if (circleLink) circleLink.href = item.link || "#";
                }
            }));
        })).catch((error => console.error("Error loading JSON:", error)));
