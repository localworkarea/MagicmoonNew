...
class Popup {
	constructor(options) {
		...
		this.buttonId = ''; // Новый параметр для хранения ID кнопки
		...
		document.addEventListener("click", function (e) {
			...
			if (buttonOpen) {
				...
				if (this._dataValue !== 'error') {
					...
					// ДОБАВЛЕНО ДЛЯ ПЕРЕХВАТА ID ----------------------------
					this.buttonId = buttonOpen.id || 'no-id'; // Сохраняем ID кнопки или фиксированное значение
					// -------------------------------------------------------
